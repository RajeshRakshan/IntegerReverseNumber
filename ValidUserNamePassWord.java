...
class MainMethodUserNamePassWord {
	...
	public static void main(String[] args) {
		...
		Matcher m4=p4.matcher(passWord);
		 ...
		 find3 = m3.find();
		 find4 = m4.find();}
			while(find1==false||find2==false||find3==false||find4==false);
		...
		ValidUserNamePassWord obj=new ValidUserNamePassWord();
		obj.setUSERNAME(userName);
		obj.setPASSWORD(passWord);
		String USER = obj.getUSERNAME();
		String PASS = obj.getPASSWORD();
                 System.out.println("You have created New E-mail ID and Password successfully");
